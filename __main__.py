    ...
    while True:  # official theme song: Also sprach Zarathustra, Op. 30
        for ev in pygame.event.get():
            if ev.type == pygame.KEYDOWN:
                ...
                screen.blit(rn, (600, 325))
                screen.blit(rn_min, (600, 350))
                screen.blit(rn_max, (600, 375))
                screen.blit(rn_last, (600, 400))
                screen.blit(rn_avg, (600, 425))
                screen.blit(rh, (600, 400))
                screen.blit(rh_min, (600, 450))
                screen.blit(rh_max, (600, 475))
                screen.blit(rh_last, (600, 525))
                screen.blit(rh_avg, (600, 550))
                pygame.display.flip()
